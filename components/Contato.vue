      ...
      <div class="mt-80 d-flex justify-content-xs-center justify-content-sm-center justify-content-lg-between row mx-auto">
        <div class="col-sm-6 px-0 col-lg">
          ...
          <div class="d-flex justify-content-center">
            <a href="tel:4732400934" class="text-center">
          ...
          <div class="d-flex justify-content-center">
            <a href="tel:4840429661" class="text-center">
          ...
          <div class="d-flex justify-content-center">
            <a href="tel:4140427365" class="text-center">
          ...
          <div class="d-flex justify-content-center">
            <a href="tel:4932400948" class="text-center">
