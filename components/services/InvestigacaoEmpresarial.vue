<template scoped>
  <div>
    <div id="content-servicos-2" v-scroll="ScrollContent" class="mt-70 col-md-10 col-lg-12 px-0 d-flex position-relative justify-content-start align-items-center row mx-auto">
      ...
      <div :class="{'show-img-servicos-1': ShowImgScroll}" class="col-lg-7 hide-img-servicos-1 px-0">
        <img src="../../assets/img/servicos/bg-empresarial.webp" class="img-fluid shadow" alt="Investigação empresarial">
      </div>
    </div>
