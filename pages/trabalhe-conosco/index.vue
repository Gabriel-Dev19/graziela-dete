<template>
  <div>
    <Home title-home="Seja um detetive de sucesso! Trabalhe com a agência Graziella Bastos" :bg-home="true" />
    <section class="pt-100">
      <div class="container">
        <h1 class="font-teko position-relative col-12 px-0 d-flex justify-content-center text-uppercase text-center">
          Saiba como trabalhar com a agência Graziella Bastos
...
export default {
  ...
  layout: 'LayoutSobre',
  head: {
    title: 'Trabalhe conosco - Agência de detetives Graziella Bastos'
  },
  mounted () {
    this.$smoothScroll({
