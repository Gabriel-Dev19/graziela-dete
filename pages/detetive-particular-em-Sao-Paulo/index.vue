<template>
  <div>
    <Home title-home="Detetive particular em São Paulo" :bg-home="true" />
      ...
      <div class="container px-xs-0">
        ...
        <div class="position-relative bg-roxo-escuro border shadow border-radius-10 mt-30 overflow-hidden col-12 d-flex row mx-auto pr-0 pt-1 pb-30 pl-65">
          ...
          <a class="d-flex col-12 mt-4 px-0 py-0 text-preto-cidades fs-sm-18 fw-600 btn align-items-center" @click.prevent="SaoPaulo">
            <ion-icon class="fs-20 text-vermelho mr-2" name="navigate-circle-outline" /> São Paulo – SP
          </a>
        </div>
      </div>
    </section>
...
export default {
  ...
  methods: {
    ...
    SaoPaulo () {
      this.$router.push('/detetive-particular-em-Sao-Paulo/detetive-particular-em-Sao-Paulo-SP/')
    }
  }
}
</script>
