<template>
  <div class="d-flex px-3 row max-auto">
    <div class="w-imprensa mt-50">
      <iframe
        class="col-12 shadow-sm px-0"
        src="https://www.youtube.com/embed/cTs6FduQ4A8"
...
export default {
  ...
  head: {
    title: 'Imprensa - Todas - Agência de detetives Graziella Bastos'
  }
}
</script>
<style scoped>
