<template>
  <div>
    <Home title-home="Detetive particular em Goiás" :bg-home="true" />
    <section class="pt-100">
      <div class="container">
        <h1 class="font-teko position-relative col-12 px-0 d-flex justify-content-center text-uppercase text-center">
          Contate um detetive particular em Goiás
          <div class="separation-tema" />
        </h1>
        <p class="mt-35 text-center fw-500 px-0">
          A <b>Agência de Detetives Graziella Bastos</b> está em <b>Goiás</b> e queremos ajudar você a desvendar suas
      ...
      <div class="container px-xs-0">
        ...
        <div class="position-relative bg-roxo-escuro border shadow border-radius-10 mt-30 overflow-hidden col-12 d-flex row mx-auto pr-0 pt-1 pb-30 pl-65">
          ...
          <a class="d-flex col-12 mt-4 px-0 py-0 text-preto-cidades fs-sm-18 fw-600 btn align-items-center" @click.prevent="Goiania">
            <ion-icon class="fs-20 text-vermelho mr-2" name="navigate-circle-outline" /> Goiânia – GO
          </a>
        </div>
      </div>
    </section>
...
export default {
  ...
  layout: 'LayoutSobre',
  head: {
    title: 'Detetive particular em Goiás - Agência de detetives Graziella Bastos'
  },
  mounted () {
    this.$smoothScroll({
  ...
  methods: {
    ...
    Goiania () {
      this.$router.push('/detetive-particular-em-Goias/detetive-particular-em-Goiania-GO/')
    }
  }
}
</script>
